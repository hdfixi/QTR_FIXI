...
class QTRSensors
{
  public:
    ...
    int readLine(unsigned int *sensor_values, unsigned char readMode = QTR_EMITTERS_ON, unsigned char white_line = 0,bool t=true);
    
    
    
    //realine modified
    int readLineM(unsigned int *sensor_values, unsigned char readMode = QTR_EMITTERS_ON, unsigned char white_line = 0,bool t=true);
